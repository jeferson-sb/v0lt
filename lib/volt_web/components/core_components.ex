defmodule VoltWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: VoltWeb.Gettext
  ...
  def header(assigns) do
    ~H"""
    <header class={[@actions != [] && "flex items-center justify-between gap-6 col-span-full", @class]}>
      <div>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VoltWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VoltWeb.Gettext, "errors", msg, opts)
    end
  end
